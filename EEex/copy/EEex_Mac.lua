...
for _, macroEntry in ipairs({
	...
	{"add_esp_dword", "81 C4"},
	{"add_esp_eax", "03 E0"},
	{"add_[ebp+dword]_eax", "01 85"},
	{"add_[ecx+dword]_eax", "01 81"},
	{"add_[ecx]_eax", "01 01"},
	{"add_[esp]_eax", "01 04 24"},
	{"and_eax_byte", "83 E0"},
	{"and_eax_dword", "25"},
	...
	{"mov_esi_[esi]", "8B 36"},
	{"mov_esi_[esp+byte]", "8B 74 24"},
	{"mov_esi_[esp]", "8B 34 24"},
